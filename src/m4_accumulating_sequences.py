...
def run_test_make_simple_list():
    ...
    # My Test 1:
    expected = [100, 101, 102, 103, 104, 105, 106, 107, 108, 109, 110, 111, 112, 113, 114, 115, 116, 117, 118, 119, 120]
    actual = make_simple_list(100, 120)
    print('Expected:', expected)
    print('Actual:  ', actual)

    # My Test 2:
    expected = [12, 13, 14, 15, 16, 17]
    actual = make_simple_list(12, 17)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def run_test_make_simple_string():
    ...
    actual = make_simple_string(100, 110)
    print('Expected:', expected)
    print('Actual:  ', actual)

    # My Test 2:
    expected = '37-'
    actual = make_simple_string(37, 37)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def run_test_make_less_simple_string():
    ...
    # My Test 1:
    expected = '100-101-102-103-104-105-106-107-108-109-110'
    actual = make_less_simple_string(100, 110)
    print('Expected:', expected)
    print('Actual:  ', actual)

    # My Test 2:
    expected = '37'
    actual = make_less_simple_string(37, 37)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def rectangles_from_circles(circles):
    ...
    for k in range(len(circles)):
        ...
        topleftcor = rg.Point(center_x - radius, center_y - radius)
        botrightcor = rg.Point(center_x + radius, center_y + radius)
        rectangles.append(rg.Rectangle(topleftcor, botrightcor))
